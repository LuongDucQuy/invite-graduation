...
export function EventSettings({ event, onUpdate }: EventSettingsProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 max-w-4xl">
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, graduateName: e.target.value })
              }
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, graduateMessage: e.target.value })
            }
            className="w-full px-3.5 py-2 rounded-xl border border-slate-200 focus:border-champagne-500 outline-none text-sm text-slate-800"
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4">
        <h3 className="font-semibold text-slate-800 text-base flex items-center gap-2">
          <Calendar className="w-4 h-4 text-champagne-600" /> Thời gian &amp;
          Địa điểm
        </h3>
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4">
        <h3 className="font-semibold text-slate-800 text-base flex items-center gap-2">
          <Music className="w-4 h-4 text-champagne-600" /> Hình ảnh &amp; Nhạc
          nền
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
