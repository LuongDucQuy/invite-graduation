    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Tổng cộng: <strong>{messages.length}</strong> lời chúc được gửi từ
          khách mời
        </p>
      </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-champagne-100 text-champagne-800  font-bold text-xs flex items-center justify-center">
