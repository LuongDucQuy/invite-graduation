    ...
    <section className="relative py-14 px-4 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h3 className="font-serif text-2xl md:text-4xl font-bold text-slate-900 tracking-tight">
        ...
        {isExpired ? (
          ...
          >
            ...
            <h4 className="font-serif text-2xl md:text-3xl font-bold text-champagne-300">
              THE DAY HAS ARRIVED 🎓
            </h4>
          ...
          <div className="grid grid-cols-4 gap-3 md:gap-6 max-w-2xl mx-auto">
            {timeUnits.map((unit, index) => (
              ...
              >
                <span className="font-serif text-2xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-slate-900 via-slate-800 to-champagne-800">
